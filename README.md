...
Of some interest is that quite often the temperature in the lower part of the tank is **higher** than that in the upper. This confused me initially because it's fairly common knowledge that heat rises so you would expect this not to be the case. However given that the heat exchanger itself sits directly below where the sensor is located this behaviour then makes perfect sense. Over a period of the ensuing hours, the temperatures then level out.

<img width="500" height="212" alt="temp-profile" src="https://github.com/user-attachments/assets/c6d0e913-3169-458f-b2be-36b1557d7963" />
